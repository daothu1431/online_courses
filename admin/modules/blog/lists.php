...
// Lấy dứ liệu blog
$listblog = getRaw("SELECT blog.id, title, blog.thumbnail, blog.create_at, student.fullname, blog.status FROM blog
INNER JOIN student ON blog.student_id = student.id
      ...
      <div class="container-fluid">
            ...
            <form action="" method="get">
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="search" name="keyword" id="" class="form-control" placeholder="Nhập tên bài viết cần tìm..." value="<?php echo (!empty($keyword))?$keyword:false; ?>">
                    </div>
                    <div class="col-3">
