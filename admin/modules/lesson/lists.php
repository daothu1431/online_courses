...
$listAlllesson = getRaw(
    "SELECT lesson.id, lesson.name as les_name, video, lesson.create_at,
     nameCourse, chapter.name as chap_name 
...
<div class="container">
    ...
    <p>
        ...
        <a href="<?php echo getLinkAdmin('lesson', 'deleteAll'); ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa tất cả không ?')"><i class="fa fa-plus"></i> Xóa tất cả</a>
    </p>
    <hr/>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th wìdth="2%">ID</th>
                <th wìdth="20%">Tên</th>
                <th max-wìdth="20%">Video</th>
                <th wìdth="10%">Khóa học</th>
                <th wìdth="10%">Học phần</th>
                <th wìdth="3%">Sửa</th>
                <th wìdth="3%">Xóa</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $item['nameCourse'] ?></td>
