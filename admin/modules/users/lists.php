...
$listAllUsers = getRaw("SELECT users.id, fullname, thumbnail, phone, email, users.create_at, groups.name, status FROM users INNER JOIN groups ON users.group_id = groups.id $filter ORDER BY users.create_at DESC LIMIT $offset, $perPage");
