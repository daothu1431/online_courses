...
if(isPost()) {
  ...
  if(empty($errors)) {
    ...
    if ($insertStatus) {
        setFlashData('msg', 'Thêm học viên thành công');
        setFlashData('msg_type', 'success');
        redirect('admin/?module=student&action=lists');
    }else {
    setFlashData('msg', 'Hệ thống đang gặp sự cố, vui lòng thử lại sau');
    setFlashData('msg_type', 'danger');
    redirect('admin/?module=student&action=add'); 
    }
        ...
        <form action="" method="post">
            ...
            <div class="col">
                <div class="d-flex">
                    ...
                    <a style="margin-left: 20px " href="<?php echo getLinkAdmin('student', 'lists') ?>" class="btn btn-success">Trở về</a>
                </div>
            </div>
        </form>
    </div>
