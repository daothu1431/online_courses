...
$listAllorderCourse = getRaw(
    "SELECT orderCourse.id, student.fullname, orderCourse.create_at, course.nameCourse, student.email, course.price, orderCourse.status
     FROM orderCourse INNER JOIN course ON orderCourse.course_id = course.id 
     INNER JOIN student ON orderCourse.student_id = student.id
